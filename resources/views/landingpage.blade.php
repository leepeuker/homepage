...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Lee Peuker</title>
    <meta name="description" content="Homepage of Lee Peuker">
    <meta name="author" content="Lee Peuker">
    ...
    <!-- script
    ================================================== -->
    <script src="js/landingpage/modernizr.js"></script>
    <script src="js/landingpage/pace.min.js"></script>
...
<body id="top">
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/daniel-leone-185834-unsplash.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <ul class="home-social">
            <li>
                <a href="https://www.xing.com/profile/Lee_Peuker" target="_blank"><i class="fa fa-xing" aria-hidden="true"></i><span>Xing</span></a>
            </li>
            <li>
                <a href="https://www.linkedin.com/in/lee-peuker-b07757172" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i><span>LinkedIn</span></a>
            </li>
            <li>
                <a href="https://github.com/leepeuker" target="_blank"><i class="fa fa-github" aria-hidden="true"></i><span>GitHub</span></a>
            </li>
        </ul> 
        <!-- end home-social -->
    ...
    <section id='services' class="s-services">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-2">I love Backend Web-Development and DevOps</h1>
            </div>
        ...
        <div class="row services-list block-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Everything happing in the backend of web pages & applications is my world. 
                    Apis, services, databases, client-server communication, etc. 
                    My aim is to deliver robust, sustainable, secure and clean solutions in every aspect!
                    </p>
                </div>
            </div>
    ...
    <section id="contact" class="s-contact">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-2 display-2--light">Feel free to contact me anytime!</h1>
            </div>
        </div>
